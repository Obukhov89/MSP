...
Route::get('/getFormComposition', [\App\Http\Controllers\ContestController::class, 'getFormComposition']);
Route::get('/getNameContests', [\App\Http\Controllers\ContestController::class, 'getContestsList']);
Route::get('/getAllContests', [\App\Http\Controllers\ContestController::class, 'getAllContests']);
Route::post('/setNewContest', [\App\Http\Controllers\ContestController::class, 'setNewContest', function(Request $request){}]);
Route::post('reqReadyCompCont', [\App\Http\Controllers\ContestController::class, 'reqReadyCompCont', function(Request $request){}]);
